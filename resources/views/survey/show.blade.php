...
<div class="container my-4">
    ...
    <form method="post" action="{{ route('survey.submit', $feedback) }}">
        @csrf
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label">When did you start your current training?</label>
                    <input
                        type="month"
                    ...
                    >
                    <div class="form-text">
                        Select the month and year you started (for example, March 2007).
                    </div>
                </div>
            </div>
        </div>
